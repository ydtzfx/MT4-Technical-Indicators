...
int init() {
   SetIndexStyle(0,DRAW_HISTOGRAM,STYLE_SOLID,3);SetIndexBuffer(0,termSpread);SetIndexLabel(0,"Vol Spread");
   SetIndexStyle(1,DRAW_LINE,STYLE_SOLID,1,clrTomato);SetIndexBuffer(1,shortVol);SetIndexLabel(1,"Short Vol");
   SetIndexStyle(2,DRAW_LINE,STYLE_SOLID,1,clrYellow);SetIndexBuffer(2,midVol);SetIndexLabel(2,"Mid Vol");
