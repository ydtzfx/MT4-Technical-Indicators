...
int init() {
   ...
   SetIndexStyle(1,DRAW_LINE,STYLE_SOLID,2,clrYellow);SetIndexBuffer(1,orLow);SetIndexLabel(1,"OR Low");
   SetIndexStyle(2,DRAW_LINE,STYLE_DOT,1,clrGray);SetIndexBuffer(2,orMid);SetIndexLabel(2,"OR Mid");
