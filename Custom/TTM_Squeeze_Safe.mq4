...
double momBuffer[],squeezeOn[],squeezeOff[],buySignal[],sellSignal[];
...
int start() {
   ...
   if(Bars>0){momBuffer[0]=momBuffer[1];squeezeOn[0]=squeezeOff[0]=0;buySignal[0]=sellSignal[0]=EMPTY_VALUE;}
   return(0);
}
