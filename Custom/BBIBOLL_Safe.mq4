...
int init() {
   SetIndexStyle(0,DRAW_LINE,STYLE_SOLID,2,InpBBIColor);SetIndexBuffer(0,bbi);SetIndexEmptyValue(0,EMPTY_VALUE);SetIndexLabel(0,"BBI");
   SetIndexStyle(1,DRAW_LINE,STYLE_SOLID,1,InpBandColor);SetIndexBuffer(1,upper);SetIndexEmptyValue(1,EMPTY_VALUE);SetIndexLabel(1,"Upper");
   SetIndexStyle(2,DRAW_LINE,STYLE_SOLID,1,InpBandColor);SetIndexBuffer(2,lower);SetIndexEmptyValue(2,EMPTY_VALUE);SetIndexLabel(2,"Lower");
