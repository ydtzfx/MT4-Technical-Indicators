...
double bullOB[],bearOB[],buySignal[],sellSignal[];
...
int start() {
   ...
   for(int i=limit;i>=0;i--){bullOB[i]=EMPTY_VALUE;bearOB[i]=EMPTY_VALUE;buySignal[i]=EMPTY_VALUE;sellSignal[i]=EMPTY_VALUE;}
