...
int init(){SetIndexStyle(0,DRAW_ARROW,STYLE_SOLID,2,clrTomato);SetIndexBuffer(0,testResist);SetIndexArrow(0,ARROW_SELL);SetIndexLabel(0,"Test Resist");SetIndexEmptyValue(0,EMPTY_VALUE);SetIndexStyle(1,DRAW_ARROW,STYLE_SOLID,2,clrLimeGreen);SetIndexBuffer(1,testSupport);SetIndexArrow(1,ARROW_BUY);SetIndexLabel(1,"Test Support");SetIndexEmptyValue(1,EMPTY_VALUE);SetIndexStyle(2,DRAW_ARROW,STYLE_SOLID,3,CLR_BUY_SIGNAL);SetIndexBuffer(2,buySignal);SetIndexArrow(2,ARROW_BUY);SetIndexEmptyValue(2,EMPTY_VALUE);SetIndexStyle(3,DRAW_ARROW,STYLE_SOLID,3,CLR_SELL_SIGNAL);SetIndexBuffer(3,sellSignal);SetIndexArrow(3,ARROW_SELL);SetIndexEmptyValue(3,EMPTY_VALUE);IndicatorDigits(0);IndicatorShortName("KeyLevel_Safe");return(0);}
int deinit(){return(0);}
