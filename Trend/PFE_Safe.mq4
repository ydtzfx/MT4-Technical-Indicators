...
double pfe[],buySignal[],sellSignal[];

int init() {
   SetIndexStyle(0,DRAW_LINE,STYLE_SOLID,2,clrDodgerBlue);SetIndexBuffer(0,pfe);SetIndexLabel(0,"PFE");
...
int start() {
   ...
   if(Bars>0){pfe[0]=pfe[1];buySignal[0]=sellSignal[0]=EMPTY_VALUE;}
   return(0);
}
