...
int init() {
   SetIndexStyle(0,DRAW_LINE,STYLE_SOLID,1,clrRoyalBlue);SetIndexBuffer(0,upper);SetIndexLabel(0,"Donchian Upper");
   SetIndexStyle(1,DRAW_LINE,STYLE_SOLID,2,clrOrange);SetIndexBuffer(1,middle);SetIndexLabel(1,"Donchian Mid");
   SetIndexStyle(2,DRAW_LINE,STYLE_SOLID,1,clrRoyalBlue);SetIndexBuffer(2,lower);SetIndexLabel(2,"Donchian Lower");
...
int start() {
   ...
   if(Bars>0){upper[0]=upper[1];lower[0]=lower[1];middle[0]=middle[1];buySignal[0]=sellSignal[0]=EMPTY_VALUE;}
   return(0);
}
